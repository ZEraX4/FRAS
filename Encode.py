...
ap = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                             description="Encode video files or images", epilog=""
                                         ...
                                         "\tpython Encode.py -d Train -i     # encode images only in 'Train' "
                                                                                "directory\n "
                                         "\tpython Encode.py -d Train -v     # encode videos only in 'Train' "
                                                                                "directory\n "
                                         "\tpython Encode.py -d Train -i -v  # encode both videos and images in "
                                                                                "'Train'\n "
                                         "\tpython Encode.py -p              # print the contents of the enc.dat file "
                                                                                "if "
                                         "exists\n "
